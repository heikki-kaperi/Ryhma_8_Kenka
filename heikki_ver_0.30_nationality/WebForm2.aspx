<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="tyhja_7.WebForm2" %>
...
<!--	Tästä kohtaan lomake kyselyn täyttäminen alkaa	-->
    ...
    <form id="form1" runat="server">
        <div>
            ...
            // Initialize ship nationality if it doesn't exist
            ...
            // Dictionary to store ship names and nationalities
            Dictionary<string, string> shipDetails = new Dictionary<string, string>();
            ...
            if (!string.IsNullOrEmpty(selectedPort))
            {
                try
                {
                    ...
                    while (rivi >= 0)
                    {
                        ...
                        if (lahtosatama != "FI" && onTulossa)
                        {
                            ...
                            if (nationalityPaikka >= 0)
                            {
                                ...
                                // Store both ship name and nationality
                                shipDetails[laivanNimi] = nationality;
                            }
                            else
                            {
                                // No nationality found
                                shipDetails[laivanNimi] = "Unknown";
                            }
                        }
                    ...
                    // Update the nationality if the ship is selected
                    if (!string.IsNullOrEmpty(selectedShip) && shipDetails.ContainsKey(selectedShip))
                    {
                        Session["ShipNationality"] = shipDetails[selectedShip];
                        shipNationality = shipDetails[selectedShip];
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    shipDetails.Add("Error fetching ships: " + ex.Message, "");
                }
            }
            %>
            ...
            <p>
                ...
                <select class="satamavalikko" id="ddlShips" name="ddlShips">
                    ...
                    <% } else if (shipDetails.Count == 0) { %>
                        <option value="">Ei laivoja</option>
                    <% } else { %>
