							...
							<form class="satama" id="class2" runat="server" method="post" action="hakukentta">
								<select class="satamavalikko">
									<option value="">Valitse satama</option>
										...
										<%
										int i = 0;
										string[] satama = { "Helsinki", "Tukholma", "Riikka", "Tallinna" };
										while (i < satama.Length)
										{
											Response.Write ("<option value=\"");
											
											Response.Write (satama[i]);
											Response.Write ("\">");
											Response.Write (satama[i]);
					...
					<td>
							<select class="laivavalikko">
								<option value="">Valitse laiva</option>
									...
									<%
									int p = 0;
									string[] alukset = { "Viking2", "Adele", "Alisia", "Pekka" };
									while (p < alukset.Length)
									{
													Response.Write ("<option value=\"");
								
													Response.Write (alukset[p]);
													Response.Write ("\">");
													Response.Write (alukset[p]);
													Response.Write ("</options>");
